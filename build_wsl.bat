...
wsl ld -T !WSLPATH!/link.ld -nostdlib -z max-page-size=0x1000 -z noexecstack -o !WSLPATH!/build/kernel.elf !WSLPATH!/build/boot.o !WSLPATH!/build/long_mode.o !WSLPATH!/build/main.o !WSLPATH!/build/vga.o !WSLPATH!/build/serial.o !WSLPATH!/build/memory.o !WSLPATH!/build/idt.o !WSLPATH!/build/irq.o !WSLPATH!/build/timer.o !WSLPATH!/build/keyboard.o !WSLPATH!/build/syscall.o !WSLPATH!/build/task.o !WSLPATH!/build/scheduler.o !WSLPATH!/build/shell.o !WSLPATH!/build/il_runtime.o !WSLPATH!/build/interrupt_stubs.o !WSLPATH!/build/context.o !WSLPATH!/build/gdt.o !WSLPATH!/build/io.o
